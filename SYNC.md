...
| `src/app/domain/services` + `src/app/tools/modeler/services` | `src/modeler/service/*` plus `src/modeler/infrastructure/{DiagramJsModelerAdapter,DiagramJsIconAdapter,EditorSessionOwner}.ts` (ModelerService/InitializerService ≈ `EgonClient` and the active-session adapters/owner; candidate-session staging has no upstream counterpart)                                                                                                                                                                                                                                                                                                                                                                                                                                     |
